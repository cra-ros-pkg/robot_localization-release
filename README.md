## robot_localization (noetic) - 2.7.7-1

The packages in the `robot_localization` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic robot_localization` on `Thu, 29 Aug 2024 09:08:07 -0000`
...
## robot_localization (noetic) - 2.7.6-1

The packages in the `robot_localization` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic robot_localization` on `Tue, 16 Apr 2024 16:01:11 -0000`
...
## robot_localization (noetic) - 2.7.5-1

The packages in the `robot_localization` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic robot_localization` on `Tue, 12 Dec 2023 12:05:36 -0000`
...
## robot_localization (foxy) - 3.1.2-1

The packages in the `robot_localization` repository were released into the `foxy` distro by running `/usr/bin/bloom-release robot_localization --rosdistro foxy --track foxy` on `Tue, 20 Dec 2022 20:17:43 -0000`
...
## robot_localization (melodic) - 2.6.12-1

The packages in the `robot_localization` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -t melodic -r melodic robot_localization` on `Mon, 08 Aug 2022 13:01:51 -0000`
...
## robot_localization (noetic) - 2.7.4-1

The packages in the `robot_localization` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic robot_localization` on `Wed, 27 Jul 2022 12:05:26 -0000`
